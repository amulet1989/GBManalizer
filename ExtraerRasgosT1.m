function [Rasgos]=ExtraerRasgosT1(Ibox,ROIonly,levels)
Rasgos=zeros(1,6);
Ibox1=Ibox';
IVect=[Ibox1(:)]';
...
%Globals
Nbins=length(levels);
CaractGlobal=getGlobalTexturesT1(ROIonly,Nbins);%Ibox
%4
...
CaractH1=getGLCMtexturesT1(GLCMs(:,:,1));
%7
...
% Rasgos(5)=CaractH1.AutoCorrelation;%15
end

%% Global
function [textures] = getGlobalTexturesT1(ROIonly,Nbins)
% -------------------------------------------------------------------------
...
%% Textura
function [textures] = getGLCMtexturesT1(GLCM)
% -------------------------------------------------------------------------
...
% 12. SumAverage; and 13. Variance. (adapted from Variance and SumAverage metrics defined by Haralick in Ref. [1])
