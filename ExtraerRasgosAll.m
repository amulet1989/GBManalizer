function [Rasgos]=ExtraerRasgosAll(Ibox,ROIonly,levels)
Rasgos=zeros(1,15);
Ibox1=Ibox';
IVect=[Ibox1(:)]';
%% estadísticas descriptivas de 1er orden
Rasgos(1)=range(IVect);%ok(4)
Rasgos(2)=max(IVect);%ok(7)
Rasgos(3)=min(IVect);%ok(8)

%% Estadísticas de textura 2do orden GLCM
...
%9
Rasgos(9)=CaractH1.Entropy;
%10
Rasgos(10)=CaractH1.Homogeneity;
%11
Rasgos(11)=CaractH1.Correlation;%11
Rasgos(12)=CaractH1.SumAverage; %12
Rasgos(13)=CaractH1.Variance;   %13
Rasgos(14)=CaractH1.Dissimilarity;%14
Rasgos(15)=CaractH1.AutoCorrelation;%15
end
%% Global
